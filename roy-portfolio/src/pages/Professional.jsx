  ...
  const allPapers = [
    {
      ...
      authors: "<u><strong>Roy Rinberg</strong></u>, Annabelle Michael Carrell, Simon Henniger, Nicholas Carlini, Keri Warr",
      venue: "Preprint",
      venueFull: "Preprint (pending arXiv upload)",
      year: "2025",
      type: "preprint",
      firstAuthor: true,
      description: "Characterizing the compression-compute frontier for LLM-generated text across lossless and lossy regimes.",
      abstract: "We study the compression of LLM-generated text across lossless and lossy regimes, characterizing a compression-compute frontier where more compression is possible at the cost of more compute. For lossless compression, domain-adapted LoRA adapters can improve LLM-based arithmetic coding by 2x over compression with the base LLM alone. For lossy compression, prompting a model for a succinct rewrite then applying arithmetic coding can achieve compression ratios of approximately 0.03, a 2x improvement over compressing the original response. We further introduce Question-Asking compression (QA), an interactive lossy protocol inspired by the game \"Twenty Questions\". A small model iteratively refines its response by asking yes/no questions to a stronger model, transferring exactly one bit per answer. On 8 benchmarks spanning math, science, and code, 10 binary questions recover 23% to 72% of the capability gap between a small and large model on standard benchmarks and 7% to 38% on harder benchmarks, achieving compression ratios of 0.0006 to 0.004. This is over 100x smaller than prior LLM-based compression, suggesting that interactive protocols can transfer knowledge far more efficiently than transmitting full responses.",
      pdf: "/assets/papers/compression_powered_egress_limiting.pdf",
      links: [
        { label: "Demo", url: "https://qa-compression.royrinberg.com" },
        { label: "Blog", url: "https://www.lesswrong.com/posts/GcbkprYPCjXdysLq4/text-compression-can-be-used-to-help-secure-model-weights" },
        { label: "Twitter", url: "https://x.com/RoyRinberg/status/2029620878082986331" }
      ]
    },
    {
